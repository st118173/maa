...
set :application, 'mac'
set :repo_url, 'git@github.com:st118173/mac.git' # Edit this to match your repository
set :branch, :master
#set :deploy_to, '/home/deploy/apps/mac'
set :pty, true
...
set :ssh_options,     { forward_agent: true, user: fetch(:user), keys: %w(~/.ssh/Mac_jntu.pem.pem) }
