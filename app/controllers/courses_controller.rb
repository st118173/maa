class CoursesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @course.save
        format.html { redirect_to upload_course_path(@course), notice: 'Material was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @course.update(course_params)
        format.html { redirect_to @course, notice: 'Materila was successfully updated.' }
  ...
  def destroy
    @course.destroy
    respond_to do |format|
      format.html { redirect_to courses_url, notice: 'Material was successfully destroyed.' }
  ...
  def do_upload
    ...
    if @course.upload_file_name != unpersisted_course.upload_file_name
      ...
      content_range = request.headers['25000']
